...
const RightNav = () => {
  return (
		<div className='flex items-center gap-3'>
			<div className='w-10 h-10 items-center justify-center rounded-full cursor-pointer hidden hover:bg-gray sm:flex'>
			...
			<div className='w-10 h-10 items-center justify-center rounded-full cursor-pointer hidden hover:bg-gray sm:flex'>
				<svg enable-background='new 0 0 24 24' height='24' viewBox='0 0 24 24' width='24' focusable='false' fill='#fff'>
			...
			<div className='w-8 h-8 flex items-center justify-center rounded-full cursor-pointer bg-[#33691E] text-white'>
